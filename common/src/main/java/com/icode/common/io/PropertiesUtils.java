...
import com.icode.common.collect.SetUtils;
...
public class PropertiesUtils {
	...
	private static final class PropertiesLoaderHolder {
		...
		public static void releadInstance(){
			...
			Resource[] resources = ResourceUtils.getResources("classpath*:/config/icode-*.*");
			...
			logger.debug("Loading icode config: {}", configFiles);
