...
import com.icode.common.callback.MethodCallback;
import com.icode.common.collect.ListUtils;
import com.icode.common.lang.DateUtils;
import com.icode.common.lang.ObjectUtils;
import com.icode.common.lang.StringUtils;
import com.icode.common.reflect.ReflectUtils;
import com.icode.common.utils.excel.annotation.ExcelField;
import com.icode.common.utils.excel.annotation.ExcelField.Type;
import com.icode.common.utils.excel.annotation.ExcelFields;
			...
			for (int j = 0; j < annotationList.size(); j++){//Object[] os : annotationList){
				...
				if (val != null){
					...
					if (StringUtils.isNotBlank(ef.dictType())){
						try{
							Class<?> dictUtils = Class.forName("com.icode.modules.sys.utils.DictUtils");
