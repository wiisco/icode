 ...
 */
package com.icode.common.web.http;
...
import com.icode.common.collect.MapUtils;
import com.icode.common.io.PropertiesUtils;
import com.icode.common.lang.StringUtils;
import com.icode.common.mapper.JsonMapper;
import com.icode.common.mapper.XmlMapper;
...
public class ServletUtils {
    ...
    public static boolean isStaticFile(String uri){
		if (staticFiles == null){
			...
			if (staticFiles == null){
				try {
					throw new Exception("检测到“icode.yml”中没有配置“web.staticFile”属性。"
